...
<body class="bg-gray-100 text-gray-800">
    <div class="container mx-auto mt-10 flex flex-col md:flex-row">
        ...
        <main class="w-full md:w-3/4 bg-white p-6 rounded shadow-md md:ml-6">
            ...
            <a href="../crud/create_news.php" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4 inline-block">Add News</a>
                            ...
                            <tr>
                                ...
                                <td class="border px-4 py-2">
                                    <?php if (isset($row['image']) && $row['image']) : ?>
                                        ...
                                        $image_url = $row['image'];
                                        ?>
                                        <img src="../uploads/<?php echo $image_url; ?>" alt="News Image" class="h-12 w-12 object-cover">
                                    <?php else : ?>
                                        No Image
                                    <?php endif; ?>
                                </td>
                                <td class="border px-4 py-2">
                                    ...
                                    <a href="../crud/delete_news.php?id=<?php echo $row['id']; ?>" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Delete</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
